/*$(document).ready(function(){
	$('select[name=estado]').on('change', function(){
		$.ajax({
			type: 'GET',
			url: 'UsuarioController\carregarCidades',
			data:'codEstado='+$('select[name=estado]').val(),
			statusCode:{
				404: function(){
...
$(document).ready(function(){
		...
		function carregar_json(id, cidade_id){
		    ...
		    $.getJSON('https://gist.githubusercontent.com/letanure/3012978/raw/36fc21d9e2fc45c078e0e0e07cce3c81965db8f9/estados-cidades.json', 
		    function(data){
